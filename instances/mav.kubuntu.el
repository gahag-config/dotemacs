...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit web-mode org ob-mongo rg lua-mode js2-mode rainbow-mode docker dockerfile-mode json-mode wakatime-mode togetherly ledger-mode transpose-frame multiple-cursors ace-jump-mode expand-region highlight-indent-guides intero rust-mode lsp-java pdf-tools calfw-org calfw dired-quick-sort dired-ranger company-lsp lsp-ui lsp-mode projectile flycheck yasnippet-snippets yasnippet company helm doom-themes try powerline use-package))))
(custom-set-faces
