...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (intero monokai-theme yasnippet projectile powerline multiple-cursors latex-preview-pane helm haskell-mode gh-md flycheck fill-column-indicator expand-region csharp-mode color-theme c-eldoc ace-jump-mode company))))
